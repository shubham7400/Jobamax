...
class JobSeeker {
    ...
    fun toParseObject(): ParseObject {
        ...
        jobSeeker.put(ParseTableFields.EDUCATIONS.value, EducationGroup(educations))
        jobSeeker.put(ParseTableFields.EXPERIENCES.value, ExperienceGroup(experiences))
        jobSeeker.put(ParseTableFields.VOLUNTEERINGS.value, VolunteeringGroup(volunteerings))
        jobSeeker.put("skills", skills)
        jobSeeker.put(ParseTableFields.HARD_SKILLS.value, hardSkills)
        jobSeeker.put(ParseTableFields.SOFT_SKILLS.value, softSkills)
