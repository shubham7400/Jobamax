...
class SeekerFormatCvFragment : BaseFragment() {
    ...
    private fun setData() {
        ...
        try {
            if (jobSeeker.jobLocation.isNotEmpty()){
                val jobLocation = gson.fromJson(JSONObject(jobSeeker.jobLocation).toString(), JobLocation::class.java)
    ...
    private fun setClickListeners() {
        ...
        mainBinding.ivThemeIconGreen.setOnClickListener {
            ...
            educationAdapter.changeCardBackgroundColor(R.color.background_green, R.color.theme_light_green, R.color.theme_dark_green)
            educationAdapter.notifyDataSetChanged()
            experienceAdapter.changeCardBackgroundColor(R.color.background_green, R.color.theme_light_green, R.color.theme_dark_green)
            experienceAdapter.notifyDataSetChanged()
            volunteeringAdapter.changeCardBackgroundColor(R.color.background_green, R.color.theme_light_green, R.color.theme_dark_green)
            volunteeringAdapter.notifyDataSetChanged()
            hardSkillAdapter.changeCardBackgroundColor(R.color.background_green, R.color.theme_light_green, R.color.theme_dark_green)
            hardSkillAdapter.notifyDataSetChanged()
            ...
            changeStrokeColor(bioBinding.clProfileIv, R.color.theme_light_green, R.color.theme_dark_green )
            changeThemeButtonBackground(mainBinding.llThemeIconGreen, R.color.theme_light_green, R.color.theme_dark_green )
            mainBinding.clTopParent.setBackgroundColor(resources.getColor(R.color.background_green, null) )
        ...
        mainBinding.ivThemeIconBlue.setOnClickListener {
            ...
            educationAdapter.changeCardBackgroundColor(R.color.background_light_blue,R.color.theme_light_blue, R.color.theme_dark_blue)
            educationAdapter.notifyDataSetChanged()
            experienceAdapter.changeCardBackgroundColor(R.color.background_light_blue,R.color.theme_light_blue, R.color.theme_dark_blue)
            experienceAdapter.notifyDataSetChanged()
            volunteeringAdapter.changeCardBackgroundColor(R.color.background_light_blue,R.color.theme_light_blue, R.color.theme_dark_blue)
            volunteeringAdapter.notifyDataSetChanged()
            hardSkillAdapter.changeCardBackgroundColor(R.color.background_light_blue,R.color.theme_light_blue, R.color.theme_dark_blue)
            hardSkillAdapter.notifyDataSetChanged()
            setSoftSkillTags(R.color.theme_light_blue, R.color.theme_dark_blue)
            setInterestTags(R.color.theme_light_blue, R.color.theme_dark_blue)
            setWorkspaceTags(R.color.theme_light_blue, R.color.theme_dark_blue)
            changeStrokeColor(bioBinding.clProfileIv, R.color.theme_light_blue, R.color.theme_dark_blue )
            changeThemeButtonBackground(mainBinding.llThemeIconBlue, R.color.theme_light_blue, R.color.theme_dark_blue)
            mainBinding.clTopParent.setBackgroundColor(resources.getColor(R.color.background_light_blue, null) )
            imageViewAndDrawableIdMap.forEach{ (drawableId, imageView) ->
        ...
        mainBinding.ivThemeIconRed.setOnClickListener {
            ...
            educationAdapter.changeCardBackgroundColor(R.color.background_red, R.color.theme_light_red, R.color.theme_dark_red)
            educationAdapter.notifyDataSetChanged()
            experienceAdapter.changeCardBackgroundColor(R.color.background_red, R.color.theme_light_red, R.color.theme_dark_red)
            experienceAdapter.notifyDataSetChanged()
            volunteeringAdapter.changeCardBackgroundColor(R.color.background_red, R.color.theme_light_red, R.color.theme_dark_red)
            volunteeringAdapter.notifyDataSetChanged()
            hardSkillAdapter.changeCardBackgroundColor(R.color.background_red, R.color.theme_light_red, R.color.theme_dark_red)
            hardSkillAdapter.notifyDataSetChanged()
            ...
            changeStrokeColor(bioBinding.clProfileIv, R.color.theme_light_red, R.color.theme_dark_red )
            changeThemeButtonBackground(mainBinding.llThemeIconRed, R.color.theme_light_red, R.color.theme_dark_red)
            mainBinding.clTopParent.setBackgroundColor(resources.getColor(R.color.background_red, null) )
            imageViewAndDrawableIdMap.forEach{ (drawableId, imageView) ->
        ...
        mainBinding.ivThemeIconGrey.setOnClickListener {
            ...
            educationAdapter.changeCardBackgroundColor(R.color.background_grey, R.color.theme_light_grey, R.color.theme_dark_grey)
            educationAdapter.notifyDataSetChanged()
            experienceAdapter.changeCardBackgroundColor(R.color.background_grey, R.color.theme_light_grey, R.color.theme_dark_grey)
            experienceAdapter.notifyDataSetChanged()
            volunteeringAdapter.changeCardBackgroundColor(R.color.background_grey, R.color.theme_light_grey, R.color.theme_dark_grey)
            volunteeringAdapter.notifyDataSetChanged()
            hardSkillAdapter.changeCardBackgroundColor(R.color.background_grey, R.color.theme_light_grey, R.color.theme_dark_grey)
            hardSkillAdapter.notifyDataSetChanged()
            ...
            changeStrokeColor(bioBinding.clProfileIv, R.color.theme_light_grey, R.color.theme_dark_grey )
            changeThemeButtonBackground(mainBinding.llThemeIconGrey, R.color.theme_light_grey, R.color.theme_dark_grey)
            mainBinding.clTopParent.setBackgroundColor(resources.getColor(R.color.background_grey, null) )
            imageViewAndDrawableIdMap.forEach{ (drawableId, imageView) ->
        ...
        mainBinding.ivThemeIconYellow.setOnClickListener {
            ...
            educationAdapter.changeCardBackgroundColor(R.color.background_yellow, R.color.theme_light_yellow, R.color.theme_dark_yellow)
            educationAdapter.notifyDataSetChanged()
            experienceAdapter.changeCardBackgroundColor(R.color.background_yellow, R.color.theme_light_yellow, R.color.theme_dark_yellow)
            experienceAdapter.notifyDataSetChanged()
            volunteeringAdapter.changeCardBackgroundColor(R.color.background_yellow, R.color.theme_light_yellow, R.color.theme_dark_yellow)
            volunteeringAdapter.notifyDataSetChanged()
            hardSkillAdapter.changeCardBackgroundColor(R.color.background_yellow, R.color.theme_light_yellow, R.color.theme_dark_yellow)
            hardSkillAdapter.notifyDataSetChanged()
            ...
            changeStrokeColor(bioBinding.clProfileIv, R.color.theme_light_yellow, R.color.theme_dark_yellow)
            changeThemeButtonBackground(mainBinding.llThemeIconYellow, R.color.theme_light_yellow, R.color.theme_dark_yellow)
            mainBinding.clTopParent.setBackgroundColor(resources.getColor(R.color.background_yellow, null) )
            imageViewAndDrawableIdMap.forEach{ (drawableId, imageView) ->
        ...
        mainBinding.ivThemeIconSalmon.setOnClickListener {
            ...
            educationAdapter.changeCardBackgroundColor(R.color.background_salmon, R.color.theme_light_salmon, R.color.theme_dark_salmon)
            educationAdapter.notifyDataSetChanged()
            experienceAdapter.changeCardBackgroundColor(R.color.background_salmon, R.color.theme_light_salmon, R.color.theme_dark_salmon)
            experienceAdapter.notifyDataSetChanged()
            volunteeringAdapter.changeCardBackgroundColor(R.color.background_salmon, R.color.theme_light_salmon, R.color.theme_dark_salmon)
            volunteeringAdapter.notifyDataSetChanged()
            hardSkillAdapter.changeCardBackgroundColor(R.color.background_salmon, R.color.theme_light_salmon, R.color.theme_dark_salmon)
            hardSkillAdapter.notifyDataSetChanged()
            ...
            changeStrokeColor(bioBinding.clProfileIv, R.color.theme_light_salmon, R.color.theme_dark_salmon )
            changeThemeButtonBackground(mainBinding.llThemeIconSalmon, R.color.theme_light_salmon, R.color.theme_dark_salmon)
            mainBinding.clTopParent.setBackgroundColor(resources.getColor(R.color.background_salmon, null) )
            imageViewAndDrawableIdMap.forEach{ (drawableId, imageView) ->
        ...
        mainBinding.ivThemeIconLightSalmon.setOnClickListener {
            ...
            educationAdapter.changeCardBackgroundColor(R.color.background_light_salmon, R.color.theme_light_light_salmon, R.color.theme_dark_light_salmon)
            educationAdapter.notifyDataSetChanged()
            experienceAdapter.changeCardBackgroundColor(R.color.background_light_salmon, R.color.theme_light_light_salmon, R.color.theme_dark_light_salmon)
            experienceAdapter.notifyDataSetChanged()
            volunteeringAdapter.changeCardBackgroundColor(R.color.background_light_salmon, R.color.theme_light_light_salmon, R.color.theme_dark_light_salmon)
            volunteeringAdapter.notifyDataSetChanged()
            hardSkillAdapter.changeCardBackgroundColor(R.color.background_light_salmon, R.color.theme_light_light_salmon, R.color.theme_dark_light_salmon)
            hardSkillAdapter.notifyDataSetChanged()
            ...
            changeStrokeColor(bioBinding.clProfileIv, R.color.theme_light_light_salmon, R.color.theme_dark_light_salmon)
            changeThemeButtonBackground(mainBinding.llThemeIconLightSalmoe,  R.color.theme_light_light_salmon, R.color.theme_dark_light_salmon)
            mainBinding.clTopParent.setBackgroundColor(resources.getColor(R.color.background_light_salmon, null) )
            imageViewAndDrawableIdMap.forEach{ (drawableId, imageView) ->
        ...
        mainBinding.ivThemeIconAquamarine.setOnClickListener {
            ...
            educationAdapter.changeCardBackgroundColor(R.color.background_aquamarine, R.color.theme_light_aquamarine, R.color.theme_dark_aquamarine)
            educationAdapter.notifyDataSetChanged()
            experienceAdapter.changeCardBackgroundColor(R.color.background_aquamarine, R.color.theme_light_aquamarine, R.color.theme_dark_aquamarine)
            experienceAdapter.notifyDataSetChanged()
            volunteeringAdapter.changeCardBackgroundColor(R.color.background_aquamarine, R.color.theme_light_aquamarine, R.color.theme_dark_aquamarine)
            volunteeringAdapter.notifyDataSetChanged()
            hardSkillAdapter.changeCardBackgroundColor(R.color.background_aquamarine, R.color.theme_light_aquamarine, R.color.theme_dark_aquamarine)
            hardSkillAdapter.notifyDataSetChanged()
            ...
            changeStrokeColor(bioBinding.clProfileIv, R.color.theme_light_aquamarine, R.color.theme_dark_aquamarine)
            changeThemeButtonBackground(mainBinding.llThemeIconAquamarine,R.color.theme_light_aquamarine, R.color.theme_dark_aquamarine)
            mainBinding.clTopParent.setBackgroundColor(resources.getColor(R.color.background_aquamarine, null) )
            imageViewAndDrawableIdMap.forEach{ (drawableId, imageView) ->
        ...
        mainBinding.ivThemeIconNormal.setOnClickListener {
            ...
            educationAdapter.changeCardBackgroundColor(R.color.screen_background, R.color.theme_light_blue, R.color.theme_dark_blue)
            educationAdapter.notifyDataSetChanged()
            experienceAdapter.changeCardBackgroundColor(R.color.screen_background, R.color.theme_light_blue, R.color.theme_dark_blue)
            experienceAdapter.notifyDataSetChanged()
            volunteeringAdapter.changeCardBackgroundColor(R.color.screen_background, R.color.theme_light_blue, R.color.theme_dark_blue)
            volunteeringAdapter.notifyDataSetChanged()
            hardSkillAdapter.changeCardBackgroundColor(R.color.screen_background, R.color.theme_light_blue, R.color.theme_dark_blue)
            hardSkillAdapter.notifyDataSetChanged()
            setSoftSkillTags(R.color.theme_light_blue, R.color.theme_dark_blue)
            setInterestTags(R.color.theme_light_blue, R.color.theme_dark_blue)
            setWorkspaceTags(R.color.theme_light_blue, R.color.theme_dark_blue)
            ...
            mainBinding.clTopParent.setBackgroundColor(resources.getColor(R.color.screen_background, null) )
            imageViewAndDrawableIdMap.forEach{ (drawableId, imageView) ->
