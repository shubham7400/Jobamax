...
import com.jobamax.appjobamax.extensions.convertDateToCurrentLanguage
...
class ModifyProfileFragment : BaseFragment()  , ImagePicker.GetImage{
    ...
    private fun setClickListeners() {
        ...
        binding.ivImportResume.setOnClickListener { findNavController().navigate(R.id.action_modifyProfileFragment_to_importProfileFromLinkedIn, null) }
        ...
        binding.ivAddSoftSkill.setOnClickListener { findNavController().navigate(R.id.action_modifyProfileFragment_to_addSoftSkillsFragment, null) }
        binding.ivAddAreaOfInterest.setOnClickListener {
            addInterest()
        }
        binding.tvGoToValidateCv.setOnClickListener { saveChanges() }
    ...
    private fun saveChanges() {
        ...
        saveJobSeeker { findNavController().navigate(R.id.action_modifyProfileFragment_to_profilePreviewFragment, null) }
    }
