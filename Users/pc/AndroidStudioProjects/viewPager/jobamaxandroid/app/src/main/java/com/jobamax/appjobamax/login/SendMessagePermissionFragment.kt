...
import com.jobamax.appjobamax.databinding.FragmentSendMessagePermissionBinding
...
class SendMessagePermissionFragment : Fragment() {
    lateinit var binding: FragmentSendMessagePermissionBinding

    var user: UserTempInfo? = null

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        binding = FragmentSendMessagePermissionBinding.inflate(inflater, container, false)
        configureUi()
        return binding.root
    }
    ...
    private fun setClickListeners() {
        binding.btnAgree.setOnClickListener {
            ...
            findNavController().navigate( R.id.action_sendMessagePermissionFragment_to_privacyPolicyFragment, args)
        }
