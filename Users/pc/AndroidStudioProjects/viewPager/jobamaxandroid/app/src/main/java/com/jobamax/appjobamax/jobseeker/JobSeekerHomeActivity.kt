    ...
    private fun setTabSelection(homeTab: ImageView, favoriteTab: ImageView, chatTab: ImageView, profileTab: ImageView) {
        when (binding.tabLayout.selectedTabPosition) {
            0 -> {
                ...
                favoriteTab.setColorFilter(resources.getColor(R.color.navi_blue, null), android.graphics.PorterDuff.Mode.SRC_IN)
            ...
            1 -> {
                ...
                favoriteTab.setColorFilter(resources.getColor(R.color.colorPrimary, null), android.graphics.PorterDuff.Mode.SRC_IN)
                chatTab.setColorFilter(resources.getColor(R.color.navi_blue, null), android.graphics.PorterDuff.Mode.SRC_IN)
            }
            2 -> {
                homeTab.setColorFilter(resources.getColor(R.color.navi_blue, null), android.graphics.PorterDuff.Mode.SRC_IN)
