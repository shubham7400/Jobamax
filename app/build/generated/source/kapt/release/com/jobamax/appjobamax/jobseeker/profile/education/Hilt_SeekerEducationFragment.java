...
public abstract class Hilt_SeekerEducationFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SeekerEducationFragment_GeneratedInjector) this.generatedComponent()).injectSeekerEducationFragment(UnsafeCasts.<SeekerEducationFragment>unsafeCast(this));
    }
  }
