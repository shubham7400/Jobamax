...
public abstract class Hilt_SeekerVolunteeringListFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SeekerVolunteeringListFragment_GeneratedInjector) this.generatedComponent()).injectSeekerVolunteeringListFragment(UnsafeCasts.<SeekerVolunteeringListFragment>unsafeCast(this));
    }
  }
