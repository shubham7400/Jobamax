...
public abstract class Hilt_JobSeekerNewsletterFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((JobSeekerNewsletterFragment_GeneratedInjector) this.generatedComponent()).injectJobSeekerNewsletterFragment(UnsafeCasts.<JobSeekerNewsletterFragment>unsafeCast(this));
    }
  }
