...
public class FragmentJobSeekerPushNotificationBindingImpl extends FragmentJobSeekerPushNotificationBinding implements com.jobamax.appjobamax.generated.callback.OnClickListener.Listener {
    ...
    private FragmentJobSeekerPushNotificationBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback49 = new com.jobamax.appjobamax.generated.callback.OnClickListener(this, 2);
        mCallback48 = new com.jobamax.appjobamax.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.handler == variableId) {
            setHandler((com.jobamax.appjobamax.jobseeker.profile.account.pushNotification.JobSeekerPushNotificationInterface) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setHandler(@Nullable com.jobamax.appjobamax.jobseeker.profile.account.pushNotification.JobSeekerPushNotificationInterface Handler) {
    ...
    protected void executeBindings() {
        ...
        com.jobamax.appjobamax.jobseeker.profile.account.pushNotification.JobSeekerPushNotificationInterface handler = mHandler;
        // batch finished
        if ((dirtyFlags & 0x2L) != 0) {
            // api target 1

            this.imageView.setOnClickListener(mCallback48);
