...
public abstract class Hilt_JobSeekerPersonalInformationFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((JobSeekerPersonalInformationFragment_GeneratedInjector) this.generatedComponent()).injectJobSeekerPersonalInformationFragment(UnsafeCasts.<JobSeekerPersonalInformationFragment>unsafeCast(this));
    }
  }
