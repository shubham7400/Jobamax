...
public abstract class Hilt_SeekerCalenderFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SeekerCalenderFragment_GeneratedInjector) this.generatedComponent()).injectSeekerCalenderFragment(UnsafeCasts.<SeekerCalenderFragment>unsafeCast(this));
    }
  }
