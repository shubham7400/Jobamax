...
public class FragmentSeekerAddVolunteeringBindingImpl extends FragmentSeekerAddVolunteeringBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.iv_clear_start_date, 17);
        sViewsWithIds.put(R.id.cl_end_date, 18);
        sViewsWithIds.put(R.id.textView144, 19);
        sViewsWithIds.put(R.id.tv_end_date, 20);
        sViewsWithIds.put(R.id.iv_clear_end_date, 21);
        sViewsWithIds.put(R.id.textViewdd19, 22);
        sViewsWithIds.put(R.id.et_description, 23);
        sViewsWithIds.put(R.id.rv_company_suggestions, 24);
    }
    // views
    @NonNull
