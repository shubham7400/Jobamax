...
public class FragmentSeekerWishlistBindingImpl extends FragmentSeekerWishlistBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.iv_filter_wishlist, 3);
        sViewsWithIds.put(R.id.view2, 4);
        sViewsWithIds.put(R.id.recyclerView, 5);
        sViewsWithIds.put(R.id.ll_empty_wishlist_msg, 6);
        sViewsWithIds.put(R.id.appCompatButtonn, 7);
        sViewsWithIds.put(R.id.btn_swipe_jobs, 8);
    }
    // views
    @NonNull
