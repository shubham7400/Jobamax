...
public abstract class Hilt_JobSeekerPushNotificationFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((JobSeekerPushNotificationFragment_GeneratedInjector) this.generatedComponent()).injectJobSeekerPushNotificationFragment(UnsafeCasts.<JobSeekerPushNotificationFragment>unsafeCast(this));
    }
  }
