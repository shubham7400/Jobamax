...
public class FragmentTakeAgeBindingImpl extends FragmentTakeAgeBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.constraintLayout14, 5);
        sViewsWithIds.put(R.id.et_age1, 6);
        sViewsWithIds.put(R.id.et_age2, 7);
        sViewsWithIds.put(R.id.tv_age_error, 8);
    ...
    public FragmentTakeAgeBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 14, sIncludes, sViewsWithIds));
    }
    private FragmentTakeAgeBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
