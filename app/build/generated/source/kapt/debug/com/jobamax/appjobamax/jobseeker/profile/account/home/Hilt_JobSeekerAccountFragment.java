...
public abstract class Hilt_JobSeekerAccountFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((JobSeekerAccountFragment_GeneratedInjector) this.generatedComponent()).injectJobSeekerAccountFragment(UnsafeCasts.<JobSeekerAccountFragment>unsafeCast(this));
    }
  }
