...
public class FragmentAddNewVolunteeringBindingImpl extends FragmentAddNewVolunteeringBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.et_organisation, 10);
        ...
        sViewsWithIds.put(R.id.rv_company_suggestions, 20);
    }
    // views
    @NonNull
    ...
    public FragmentAddNewVolunteeringBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 21, sIncludes, sViewsWithIds));
    }
    private FragmentAddNewVolunteeringBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
