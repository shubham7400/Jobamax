...
public abstract class Hilt_SeekerCoachingFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SeekerCoachingFragment_GeneratedInjector) this.generatedComponent()).injectSeekerCoachingFragment(UnsafeCasts.<SeekerCoachingFragment>unsafeCast(this));
    }
  }
