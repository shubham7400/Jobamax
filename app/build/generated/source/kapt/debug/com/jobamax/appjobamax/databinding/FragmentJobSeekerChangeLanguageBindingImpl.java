...
public class FragmentJobSeekerChangeLanguageBindingImpl extends FragmentJobSeekerChangeLanguageBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tv_english_language, 4);
        sViewsWithIds.put(R.id.tv_french_language, 5);
    }
    // views
    @NonNull
    ...
    public FragmentJobSeekerChangeLanguageBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }
    private FragmentJobSeekerChangeLanguageBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
