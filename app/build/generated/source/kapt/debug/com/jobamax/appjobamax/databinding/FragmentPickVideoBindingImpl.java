...
public class FragmentPickVideoBindingImpl extends FragmentPickVideoBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.cl_video, 6);
        sViewsWithIds.put(R.id.ll_loading, 7);
        sViewsWithIds.put(R.id.iv_loading, 8);
    ...
    public FragmentPickVideoBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 10, sIncludes, sViewsWithIds));
    }
    private FragmentPickVideoBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
