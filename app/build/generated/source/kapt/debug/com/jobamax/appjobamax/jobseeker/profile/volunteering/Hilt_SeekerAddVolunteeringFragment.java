...
public abstract class Hilt_SeekerAddVolunteeringFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SeekerAddVolunteeringFragment_GeneratedInjector) this.generatedComponent()).injectSeekerAddVolunteeringFragment(UnsafeCasts.<SeekerAddVolunteeringFragment>unsafeCast(this));
    }
  }
