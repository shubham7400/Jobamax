...
public class FragmentPortfolioDescriptionBindingImpl extends FragmentPortfolioDescriptionBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tv_text1, 6);
        sViewsWithIds.put(R.id.et_portfolio_description, 7);
        sViewsWithIds.put(R.id.textView31, 8);
        sViewsWithIds.put(R.id.et_link, 9);
        sViewsWithIds.put(R.id.iv_add_link, 10);
        sViewsWithIds.put(R.id.rv_links, 11);
    }
    // views
    @NonNull
