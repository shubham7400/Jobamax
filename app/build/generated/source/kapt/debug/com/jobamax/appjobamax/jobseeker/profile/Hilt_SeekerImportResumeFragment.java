...
public abstract class Hilt_SeekerImportResumeFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SeekerImportResumeFragment_GeneratedInjector) this.generatedComponent()).injectSeekerImportResumeFragment(UnsafeCasts.<SeekerImportResumeFragment>unsafeCast(this));
    }
  }
