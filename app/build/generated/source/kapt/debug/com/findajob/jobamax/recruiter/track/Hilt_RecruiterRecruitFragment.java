...
public abstract class Hilt_RecruiterRecruitFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RecruiterRecruitFragment_GeneratedInjector) this.generatedComponent()).injectRecruiterRecruitFragment(UnsafeCasts.<RecruiterRecruitFragment>unsafeCast(this));
    }
  }
