...
public abstract class Hilt_RecruiterProfileFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RecruiterProfileFragment_GeneratedInjector) this.generatedComponent()).injectRecruiterProfileFragment(UnsafeCasts.<RecruiterProfileFragment>unsafeCast(this));
    }
  }
