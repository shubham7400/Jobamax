...
public abstract class Hilt_ReviewsFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ReviewsFragment_GeneratedInjector) this.generatedComponent()).injectReviewsFragment(UnsafeCasts.<ReviewsFragment>unsafeCast(this));
    }
  }
