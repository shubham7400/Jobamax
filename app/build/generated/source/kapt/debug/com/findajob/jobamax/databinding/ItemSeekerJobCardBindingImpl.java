...
public class ItemSeekerJobCardBindingImpl extends ItemSeekerJobCardBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.appCompatButton2, 6);
        sViewsWithIds.put(R.id.tv_title_about, 7);
        sViewsWithIds.put(R.id.cl_overlay, 8);
        sViewsWithIds.put(R.id.tv_overlay_label, 9);
        sViewsWithIds.put(R.id.tv_job_offer_id, 10);
    }
    // views
    // variables
    // values
