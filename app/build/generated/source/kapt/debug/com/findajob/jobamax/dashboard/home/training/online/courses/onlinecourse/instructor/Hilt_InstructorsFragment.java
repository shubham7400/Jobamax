...
public abstract class Hilt_InstructorsFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((InstructorsFragment_GeneratedInjector) this.generatedComponent()).injectInstructorsFragment(UnsafeCasts.<InstructorsFragment>unsafeCast(this));
    }
  }
