...
public abstract class Hilt_JobSearchFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((JobSearchFragment_GeneratedInjector) this.generatedComponent()).injectJobSearchFragment(UnsafeCasts.<JobSearchFragment>unsafeCast(this));
    }
  }
