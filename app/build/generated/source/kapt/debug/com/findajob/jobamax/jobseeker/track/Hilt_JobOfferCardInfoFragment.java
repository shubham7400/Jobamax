...
public abstract class Hilt_JobOfferCardInfoFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((JobOfferCardInfoFragment_GeneratedInjector) this.generatedComponent()).injectJobOfferCardInfoFragment(UnsafeCasts.<JobOfferCardInfoFragment>unsafeCast(this));
    }
  }
