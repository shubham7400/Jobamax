...
public abstract class Hilt_RecruiterPaymentMethodsFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RecruiterPaymentMethodsFragment_GeneratedInjector) this.generatedComponent()).injectRecruiterPaymentMethodsFragment(UnsafeCasts.<RecruiterPaymentMethodsFragment>unsafeCast(this));
    }
  }
