...
public abstract class Hilt_SeekerAboutMeFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SeekerAboutMeFragment_GeneratedInjector) this.generatedComponent()).injectSeekerAboutMeFragment(UnsafeCasts.<SeekerAboutMeFragment>unsafeCast(this));
    }
  }
