...
public class ItemArchivedMessagesBindingImpl extends ItemArchivedMessagesBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.ivUnarchive, 6);
        sViewsWithIds.put(R.id.bottom_wrapper1, 7);
        sViewsWithIds.put(R.id.btnLocation, 8);
        sViewsWithIds.put(R.id.clMessageBody, 9);
        sViewsWithIds.put(R.id.item_messages_iv_avatar, 10);
        sViewsWithIds.put(R.id.iv_seen_indicator, 11);
        sViewsWithIds.put(R.id.vHorizontalLine, 12);
    }
    // views
    @NonNull
    ...
    public ItemArchivedMessagesBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 13, sIncludes, sViewsWithIds));
    }
    private ItemArchivedMessagesBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
