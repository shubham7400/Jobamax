...
public class ItemInfoBindingImpl extends ItemInfoBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.data == variableId) {
            setData((com.findajob.jobamax.jobseeker.profile.info.Info) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setData(@Nullable com.findajob.jobamax.jobseeker.profile.info.Info Data) {
        this.mData = Data;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    protected void executeBindings() {
        ...
        int dataDrawable = 0;
        com.findajob.jobamax.jobseeker.profile.info.Info data = mData;
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            com.findajob.jobamax.util.ImageBindingAdaptersKt.loadImageFromDrawable(this.ivMessage, dataDrawable);
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.tvMessage, dataMessage);
        }
    }
