...
public abstract class Hilt_RecruiterCourseFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_RecruiterCourseFragment() {
    super();
  }

  Hilt_RecruiterCourseFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RecruiterCourseFragment_GeneratedInjector) this.generatedComponent()).injectRecruiterCourseFragment(UnsafeCasts.<RecruiterCourseFragment>unsafeCast(this));
    }
  }
