...
public abstract class Hilt_JobOfferDetailsFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((JobOfferDetailsFragment_GeneratedInjector) this.generatedComponent()).injectJobOfferDetailsFragment(UnsafeCasts.<JobOfferDetailsFragment>unsafeCast(this));
    }
  }
