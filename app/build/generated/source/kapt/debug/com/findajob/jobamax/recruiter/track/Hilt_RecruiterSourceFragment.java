...
public abstract class Hilt_RecruiterSourceFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RecruiterSourceFragment_GeneratedInjector) this.generatedComponent()).injectRecruiterSourceFragment(UnsafeCasts.<RecruiterSourceFragment>unsafeCast(this));
    }
  }
