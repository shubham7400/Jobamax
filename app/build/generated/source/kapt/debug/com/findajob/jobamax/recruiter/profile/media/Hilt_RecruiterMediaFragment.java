...
public abstract class Hilt_RecruiterMediaFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RecruiterMediaFragment_GeneratedInjector) this.generatedComponent()).injectRecruiterMediaFragment(UnsafeCasts.<RecruiterMediaFragment>unsafeCast(this));
    }
  }
