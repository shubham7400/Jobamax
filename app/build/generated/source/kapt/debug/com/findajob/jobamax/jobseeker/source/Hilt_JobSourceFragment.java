...
public abstract class Hilt_JobSourceFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((JobSourceFragment_GeneratedInjector) this.generatedComponent()).injectJobSourceFragment(UnsafeCasts.<JobSourceFragment>unsafeCast(this));
    }
  }
