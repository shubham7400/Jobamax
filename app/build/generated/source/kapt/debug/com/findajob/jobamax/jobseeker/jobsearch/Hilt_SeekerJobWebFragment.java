...
public abstract class Hilt_SeekerJobWebFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SeekerJobWebFragment_GeneratedInjector) this.generatedComponent()).injectSeekerJobWebFragment(UnsafeCasts.<SeekerJobWebFragment>unsafeCast(this));
    }
  }
