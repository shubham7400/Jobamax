...
public abstract class Hilt_RecruiterAccountFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RecruiterAccountFragment_GeneratedInjector) this.generatedComponent()).injectRecruiterAccountFragment(UnsafeCasts.<RecruiterAccountFragment>unsafeCast(this));
    }
  }
