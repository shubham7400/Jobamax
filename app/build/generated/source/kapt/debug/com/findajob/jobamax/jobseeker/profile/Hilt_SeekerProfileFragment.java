...
public abstract class Hilt_SeekerProfileFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SeekerProfileFragment_GeneratedInjector) this.generatedComponent()).injectSeekerProfileFragment(UnsafeCasts.<SeekerProfileFragment>unsafeCast(this));
    }
  }
