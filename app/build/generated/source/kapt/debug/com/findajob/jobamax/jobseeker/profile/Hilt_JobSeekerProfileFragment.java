...
public abstract class Hilt_JobSeekerProfileFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((JobSeekerProfileFragment_GeneratedInjector) this.generatedComponent()).injectJobSeekerProfileFragment(UnsafeCasts.<JobSeekerProfileFragment>unsafeCast(this));
    }
  }
