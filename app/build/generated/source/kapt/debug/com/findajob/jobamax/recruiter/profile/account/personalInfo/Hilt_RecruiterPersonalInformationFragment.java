...
public abstract class Hilt_RecruiterPersonalInformationFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RecruiterPersonalInformationFragment_GeneratedInjector) this.generatedComponent()).injectRecruiterPersonalInformationFragment(UnsafeCasts.<RecruiterPersonalInformationFragment>unsafeCast(this));
    }
  }
