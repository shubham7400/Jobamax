...
public abstract class Hilt_MessagesFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MessagesFragment_GeneratedInjector) this.generatedComponent()).injectMessagesFragment(UnsafeCasts.<MessagesFragment>unsafeCast(this));
    }
  }
