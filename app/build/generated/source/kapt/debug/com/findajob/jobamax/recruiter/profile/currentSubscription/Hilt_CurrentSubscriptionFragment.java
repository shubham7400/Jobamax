...
public abstract class Hilt_CurrentSubscriptionFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CurrentSubscriptionFragment_GeneratedInjector) this.generatedComponent()).injectCurrentSubscriptionFragment(UnsafeCasts.<CurrentSubscriptionFragment>unsafeCast(this));
    }
  }
