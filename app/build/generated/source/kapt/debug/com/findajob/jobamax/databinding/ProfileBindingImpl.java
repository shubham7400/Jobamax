...
public class ProfileBindingImpl extends ProfileBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.imageView11, 1);
        ...
        sViewsWithIds.put(R.id.tv_ddd, 7);
        sViewsWithIds.put(R.id.tv_calender_title, 8);
        sViewsWithIds.put(R.id.iv_calender, 9);
        sViewsWithIds.put(R.id.tv_calender_titlef, 10);
        sViewsWithIds.put(R.id.iv_calvender, 11);
        sViewsWithIds.put(R.id.tv_calender_titlex, 12);
        sViewsWithIds.put(R.id.iv_calendxer, 13);
        sViewsWithIds.put(R.id.textView7, 14);
        sViewsWithIds.put(R.id.textView8, 15);
        sViewsWithIds.put(R.id.textView77, 16);
        sViewsWithIds.put(R.id.textView88, 17);
        sViewsWithIds.put(R.id.textView76, 18);
        sViewsWithIds.put(R.id.textView86, 19);
        sViewsWithIds.put(R.id.textView73, 20);
        sViewsWithIds.put(R.id.textView83, 21);
        sViewsWithIds.put(R.id.iv_back_buttone, 22);
    }
    // views
    @NonNull
