...
public abstract class Hilt_MasterClassFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MasterClassFragment_GeneratedInjector) this.generatedComponent()).injectMasterClassFragment(UnsafeCasts.<MasterClassFragment>unsafeCast(this));
    }
  }
