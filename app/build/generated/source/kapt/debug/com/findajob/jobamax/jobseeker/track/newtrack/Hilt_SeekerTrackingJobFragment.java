...
public abstract class Hilt_SeekerTrackingJobFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SeekerTrackingJobFragment_GeneratedInjector) this.generatedComponent()).injectSeekerTrackingJobFragment(UnsafeCasts.<SeekerTrackingJobFragment>unsafeCast(this));
    }
  }
