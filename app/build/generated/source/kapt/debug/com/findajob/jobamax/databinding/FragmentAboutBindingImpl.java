...
public class FragmentAboutBindingImpl extends FragmentAboutBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.online_course_about_title, 1);
        sViewsWithIds.put(R.id.online_course_about_recent_view_tv, 2);
        sViewsWithIds.put(R.id.online_course_about_info_tv, 3);
        sViewsWithIds.put(R.id.online_course_show_all_tv, 4);
        sViewsWithIds.put(R.id.imageView3, 5);
        sViewsWithIds.put(R.id.imageView2, 6);
        sViewsWithIds.put(R.id.imageView4, 7);
        sViewsWithIds.put(R.id.online_course_cv_tv1, 8);
        sViewsWithIds.put(R.id.online_course_cv_tv3, 9);
        sViewsWithIds.put(R.id.online_course_cv_tv2, 10);
    }
    // views
    @NonNull
