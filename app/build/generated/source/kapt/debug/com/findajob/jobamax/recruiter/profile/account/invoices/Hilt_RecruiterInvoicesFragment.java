...
public abstract class Hilt_RecruiterInvoicesFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RecruiterInvoicesFragment_GeneratedInjector) this.generatedComponent()).injectRecruiterInvoicesFragment(UnsafeCasts.<RecruiterInvoicesFragment>unsafeCast(this));
    }
  }
