...
public abstract class Hilt_OnlineCoursesListFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((OnlineCoursesListFragment_GeneratedInjector) this.generatedComponent()).injectOnlineCoursesListFragment(UnsafeCasts.<OnlineCoursesListFragment>unsafeCast(this));
    }
  }
