...
public abstract class Hilt_RecruiterPushNotificationFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RecruiterPushNotificationFragment_GeneratedInjector) this.generatedComponent()).injectRecruiterPushNotificationFragment(UnsafeCasts.<RecruiterPushNotificationFragment>unsafeCast(this));
    }
  }
