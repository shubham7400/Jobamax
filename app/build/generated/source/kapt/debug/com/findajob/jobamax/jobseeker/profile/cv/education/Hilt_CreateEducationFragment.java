...
public abstract class Hilt_CreateEducationFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CreateEducationFragment_GeneratedInjector) this.generatedComponent()).injectCreateEducationFragment(UnsafeCasts.<CreateEducationFragment>unsafeCast(this));
    }
  }
