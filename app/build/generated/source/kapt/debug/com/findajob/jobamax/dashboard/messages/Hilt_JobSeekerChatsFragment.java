...
public abstract class Hilt_JobSeekerChatsFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((JobSeekerChatsFragment_GeneratedInjector) this.generatedComponent()).injectJobSeekerChatsFragment(UnsafeCasts.<JobSeekerChatsFragment>unsafeCast(this));
    }
  }
