...
public class FragmentJobSeekerNewsletterBindingImpl extends FragmentJobSeekerNewsletterBinding implements com.findajob.jobamax.generated.callback.OnClickListener.Listener, com.findajob.jobamax.generated.callback.OnCheckedChangeListener.Listener {
    ...
    @Nullable
    private final android.widget.CompoundButton.OnCheckedChangeListener mCallback30;
    @Nullable
    ...
    private FragmentJobSeekerNewsletterBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        mCallback30 = new com.findajob.jobamax.generated.callback.OnCheckedChangeListener(this, 3);
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.handler == variableId) {
            setHandler((com.findajob.jobamax.jobseeker.profile.account.newsletter.JobSeekerNewsletterInterface) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setHandler(@Nullable com.findajob.jobamax.jobseeker.profile.account.newsletter.JobSeekerNewsletterInterface Handler) {
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x2L) != 0) {
            ...
            this.imageView.setOnClickListener(mCallback28);
            this.mboundView2.setOnClickListener(mCallback29);
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setListeners(this.newsletterCheck, mCallback30, (androidx.databinding.InverseBindingListener)null);
        }
    }
