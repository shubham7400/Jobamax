...
public abstract class Hilt_JobSeekerSocialAccountFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((JobSeekerSocialAccountFragment_GeneratedInjector) this.generatedComponent()).injectJobSeekerSocialAccountFragment(UnsafeCasts.<JobSeekerSocialAccountFragment>unsafeCast(this));
    }
  }
