...
public abstract class Hilt_JobSeekerPaymentMethodsFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((JobSeekerPaymentMethodsFragment_GeneratedInjector) this.generatedComponent()).injectJobSeekerPaymentMethodsFragment(UnsafeCasts.<JobSeekerPaymentMethodsFragment>unsafeCast(this));
    }
  }
