...
public abstract class Hilt_RecruiterChatsFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RecruiterChatsFragment_GeneratedInjector) this.generatedComponent()).injectRecruiterChatsFragment(UnsafeCasts.<RecruiterChatsFragment>unsafeCast(this));
    }
  }
