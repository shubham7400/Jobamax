...
public abstract class Hilt_LiveRoomFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LiveRoomFragment_GeneratedInjector) this.generatedComponent()).injectLiveRoomFragment(UnsafeCasts.<LiveRoomFragment>unsafeCast(this));
    }
  }
