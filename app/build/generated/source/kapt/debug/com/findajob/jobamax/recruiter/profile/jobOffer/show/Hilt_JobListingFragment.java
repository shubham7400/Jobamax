...
public abstract class Hilt_JobListingFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((JobListingFragment_GeneratedInjector) this.generatedComponent()).injectJobListingFragment(UnsafeCasts.<JobListingFragment>unsafeCast(this));
    }
  }
