...
public abstract class Hilt_SeekerWishListFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SeekerWishListFragment_GeneratedInjector) this.generatedComponent()).injectSeekerWishListFragment(UnsafeCasts.<SeekerWishListFragment>unsafeCast(this));
    }
  }
