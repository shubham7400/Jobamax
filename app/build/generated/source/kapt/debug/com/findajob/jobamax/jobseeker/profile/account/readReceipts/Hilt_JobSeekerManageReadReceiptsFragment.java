...
public abstract class Hilt_JobSeekerManageReadReceiptsFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((JobSeekerManageReadReceiptsFragment_GeneratedInjector) this.generatedComponent()).injectJobSeekerManageReadReceiptsFragment(UnsafeCasts.<JobSeekerManageReadReceiptsFragment>unsafeCast(this));
    }
  }
