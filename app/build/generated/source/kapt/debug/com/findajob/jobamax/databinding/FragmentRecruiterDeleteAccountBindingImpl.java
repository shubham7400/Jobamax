...
public class FragmentRecruiterDeleteAccountBindingImpl extends FragmentRecruiterDeleteAccountBinding implements com.findajob.jobamax.generated.callback.OnClickListener.Listener {
    ...
    public FragmentRecruiterDeleteAccountBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 7, sIncludes, sViewsWithIds));
    }
    private FragmentRecruiterDeleteAccountBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.handler == variableId) {
            setHandler((com.findajob.jobamax.recruiter.profile.account.deleteAccount.RecruiterDeleteAccountInterface) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setHandler(@Nullable com.findajob.jobamax.recruiter.profile.account.deleteAccount.RecruiterDeleteAccountInterface Handler) {
