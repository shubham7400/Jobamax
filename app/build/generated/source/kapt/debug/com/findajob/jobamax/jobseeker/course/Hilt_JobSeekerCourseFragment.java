...
public abstract class Hilt_JobSeekerCourseFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((JobSeekerCourseFragment_GeneratedInjector) this.generatedComponent()).injectJobSeekerCourseFragment(UnsafeCasts.<JobSeekerCourseFragment>unsafeCast(this));
    }
  }
