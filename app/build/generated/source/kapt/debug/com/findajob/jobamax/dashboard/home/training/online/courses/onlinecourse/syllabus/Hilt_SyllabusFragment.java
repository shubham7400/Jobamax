...
public abstract class Hilt_SyllabusFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SyllabusFragment_GeneratedInjector) this.generatedComponent()).injectSyllabusFragment(UnsafeCasts.<SyllabusFragment>unsafeCast(this));
    }
  }
