...
public abstract class Hilt_RecruiterManageReadReceiptsFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RecruiterManageReadReceiptsFragment_GeneratedInjector) this.generatedComponent()).injectRecruiterManageReadReceiptsFragment(UnsafeCasts.<RecruiterManageReadReceiptsFragment>unsafeCast(this));
    }
  }
