...
public abstract class Hilt_JobamaxClubFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((JobamaxClubFragment_GeneratedInjector) this.generatedComponent()).injectJobamaxClubFragment(UnsafeCasts.<JobamaxClubFragment>unsafeCast(this));
    }
  }
