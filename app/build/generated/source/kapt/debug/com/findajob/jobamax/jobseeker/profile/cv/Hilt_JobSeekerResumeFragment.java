...
public abstract class Hilt_JobSeekerResumeFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((JobSeekerResumeFragment_GeneratedInjector) this.generatedComponent()).injectJobSeekerResumeFragment(UnsafeCasts.<JobSeekerResumeFragment>unsafeCast(this));
    }
  }
