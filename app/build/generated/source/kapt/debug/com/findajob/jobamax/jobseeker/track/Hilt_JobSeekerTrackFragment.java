...
public abstract class Hilt_JobSeekerTrackFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((JobSeekerTrackFragment_GeneratedInjector) this.generatedComponent()).injectJobSeekerTrackFragment(UnsafeCasts.<JobSeekerTrackFragment>unsafeCast(this));
    }
  }
