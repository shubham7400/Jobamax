...
public abstract class Hilt_JobSeekerApplyFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((JobSeekerApplyFragment_GeneratedInjector) this.generatedComponent()).injectJobSeekerApplyFragment(UnsafeCasts.<JobSeekerApplyFragment>unsafeCast(this));
    }
  }
