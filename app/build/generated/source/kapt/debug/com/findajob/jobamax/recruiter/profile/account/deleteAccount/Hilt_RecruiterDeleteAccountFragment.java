...
public abstract class Hilt_RecruiterDeleteAccountFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RecruiterDeleteAccountFragment_GeneratedInjector) this.generatedComponent()).injectRecruiterDeleteAccountFragment(UnsafeCasts.<RecruiterDeleteAccountFragment>unsafeCast(this));
    }
  }
