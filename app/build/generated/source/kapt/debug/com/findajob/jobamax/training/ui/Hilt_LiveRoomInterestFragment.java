...
public abstract class Hilt_LiveRoomInterestFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LiveRoomInterestFragment_GeneratedInjector) this.generatedComponent()).injectLiveRoomInterestFragment(UnsafeCasts.<LiveRoomInterestFragment>unsafeCast(this));
    }
  }
