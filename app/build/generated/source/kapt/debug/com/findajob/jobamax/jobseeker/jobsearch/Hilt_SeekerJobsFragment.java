...
public abstract class Hilt_SeekerJobsFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SeekerJobsFragment_GeneratedInjector) this.generatedComponent()).injectSeekerJobsFragment(UnsafeCasts.<SeekerJobsFragment>unsafeCast(this));
    }
  }
