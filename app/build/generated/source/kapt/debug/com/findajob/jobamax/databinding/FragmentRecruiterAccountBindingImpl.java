...
public class FragmentRecruiterAccountBindingImpl extends FragmentRecruiterAccountBinding implements com.findajob.jobamax.generated.callback.OnClickListener.Listener, com.findajob.jobamax.generated.callback.OnCheckedChangeListener.Listener {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.customToolbar, 25);
    }
    // views
    @NonNull
    ...
    public FragmentRecruiterAccountBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 26, sIncludes, sViewsWithIds));
    }
    private FragmentRecruiterAccountBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.handler == variableId) {
            setHandler((com.findajob.jobamax.recruiter.profile.account.home.RecruiterAccountInterface) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setHandler(@Nullable com.findajob.jobamax.recruiter.profile.account.home.RecruiterAccountInterface Handler) {
