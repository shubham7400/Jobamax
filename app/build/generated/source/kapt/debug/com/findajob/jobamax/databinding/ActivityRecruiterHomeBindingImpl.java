...
public class ActivityRecruiterHomeBindingImpl extends ActivityRecruiterHomeBinding implements com.findajob.jobamax.generated.callback.OnClickListener.Listener {
    ...
    public ActivityRecruiterHomeBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 16, sIncludes, sViewsWithIds));
    }
    private ActivityRecruiterHomeBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.state == variableId) {
            ...
            setHandler((com.findajob.jobamax.recruiter.home.RecruiterHomeInterface) variable);
        }
    ...
    public void setHandler(@Nullable com.findajob.jobamax.recruiter.home.RecruiterHomeInterface Handler) {
