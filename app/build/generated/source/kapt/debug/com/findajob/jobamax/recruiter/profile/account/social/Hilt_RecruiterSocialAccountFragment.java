...
public abstract class Hilt_RecruiterSocialAccountFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RecruiterSocialAccountFragment_GeneratedInjector) this.generatedComponent()).injectRecruiterSocialAccountFragment(UnsafeCasts.<RecruiterSocialAccountFragment>unsafeCast(this));
    }
  }
