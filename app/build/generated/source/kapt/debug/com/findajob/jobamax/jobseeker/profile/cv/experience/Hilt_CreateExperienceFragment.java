...
public abstract class Hilt_CreateExperienceFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CreateExperienceFragment_GeneratedInjector) this.generatedComponent()).injectCreateExperienceFragment(UnsafeCasts.<CreateExperienceFragment>unsafeCast(this));
    }
  }
