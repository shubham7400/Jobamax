...
public class FragmentMeetNearbyPeopleBindingImpl extends FragmentMeetNearbyPeopleBinding implements com.findajob.jobamax.generated.callback.OnClickListener.Listener {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.handler == variableId) {
            setHandler((com.findajob.jobamax.login.MeetPeopleNearbyInterface) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setHandler(@Nullable com.findajob.jobamax.login.MeetPeopleNearbyInterface Handler) {
