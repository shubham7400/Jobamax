...
public abstract class Hilt_SeekerPreviewFragment<V extends ViewDataBinding> extends BaseFragmentMain<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SeekerPreviewFragment_GeneratedInjector) this.generatedComponent()).injectSeekerPreviewFragment(UnsafeCasts.<SeekerPreviewFragment>unsafeCast(this));
    }
  }
