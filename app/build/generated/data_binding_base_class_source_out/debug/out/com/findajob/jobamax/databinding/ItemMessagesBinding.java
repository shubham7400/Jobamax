...
public abstract class ItemMessagesBinding extends ViewDataBinding {
  ...
  protected ItemMessagesBinding(Object _bindingComponent, View _root, int _localFieldCount,
      ...
      TextView itemMessagesIvName, ImageView ivDelete, ImageView ivSeenIndicator,
      ImageView ivShortList, SwipeLayout slMessageSwipe, View vHorizontalLine) {
   ...
   * @Deprecated Use DataBindingUtil.inflate(inflater, R.layout.item_messages, root, attachToRoot, component)
   */
  @NonNull
  @Deprecated
  public static ItemMessagesBinding inflate(@NonNull LayoutInflater inflater,
      @Nullable ViewGroup root, boolean attachToRoot, @Nullable Object component) {
    return ViewDataBinding.<ItemMessagesBinding>inflateInternal(inflater, R.layout.item_messages, root, attachToRoot, component);
  }
   ...
   * compilation fails for another reason.
   * https://issuetracker.google.com/issues/116541301
   * @Deprecated Use DataBindingUtil.inflate(inflater, R.layout.item_messages, null, false, component)
   */
  @NonNull
  @Deprecated
  public static ItemMessagesBinding inflate(@NonNull LayoutInflater inflater,
      @Nullable Object component) {
    return ViewDataBinding.<ItemMessagesBinding>inflateInternal(inflater, R.layout.item_messages, null, false, component);
  }

  public static ItemMessagesBinding bind(@NonNull View view) {
   ...
   */
  @Deprecated
  public static ItemMessagesBinding bind(@NonNull View view, @Nullable Object component) {
    return (ItemMessagesBinding)bind(component, view, R.layout.item_messages);
  }
}
