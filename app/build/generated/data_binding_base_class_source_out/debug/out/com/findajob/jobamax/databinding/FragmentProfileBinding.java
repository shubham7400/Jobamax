...
public abstract class FragmentProfileBinding extends ViewDataBinding {
  @NonNull
  public final MaterialButton profileBReach;

  @NonNull
  public final ImageView profileIvCompanyIcon;

  @NonNull
  public final ImageView profileIvTopBg;

  @NonNull
  public final RecyclerView profileRvInfo;

  @NonNull
  public final TextView profileTvCompanyName;

  protected FragmentProfileBinding(Object _bindingComponent, View _root, int _localFieldCount,
      MaterialButton profileBReach, ImageView profileIvCompanyIcon, ImageView profileIvTopBg,
      RecyclerView profileRvInfo, TextView profileTvCompanyName) {
    super(_bindingComponent, _root, _localFieldCount);
    this.profileBReach = profileBReach;
    this.profileIvCompanyIcon = profileIvCompanyIcon;
    this.profileIvTopBg = profileIvTopBg;
    this.profileRvInfo = profileRvInfo;
    this.profileTvCompanyName = profileTvCompanyName;
  }
