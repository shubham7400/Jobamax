...
public final class DialogMessageBinding implements ViewBinding {
  ...
  private DialogMessageBinding(@NonNull CardView rootView, @NonNull ImageView ivLogo,
      @NonNull Button primaryButton, @NonNull TextView tvMessage) {
  ...
  public static DialogMessageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogMessageBinding((CardView) rootView, ivLogo, primaryButton, tvMessage);
    }
