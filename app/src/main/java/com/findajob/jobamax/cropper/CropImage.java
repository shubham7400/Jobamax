...
public final class CropImage {
    ...
    public static void startPickImageActivity(@NonNull Activity activity, File photoFile) {
        activity.startActivityForResult(getPickImageChooserIntent(activity, photoFile), PICK_IMAGE_CHOOSER_REQUEST_CODE);
    }

    /**
     * Same as {@link #startPickImageActivity(Activity, File) startPickImageActivity} method but instead of
    ...
    public static void startPickImageActivity(@NonNull Context context, @NonNull Fragment fragment, File photoFile) {
        fragment.startActivityForResult(getPickImageChooserIntent(context, photoFile), PICK_IMAGE_CHOOSER_REQUEST_CODE);
    }
    ...
    public static Intent getPickImageChooserIntent(@NonNull Context context, File photoFile) {
        return getPickImageChooserIntent(context, "Select Source", false, true, photoFile);
    }
    ...
    public static Intent getPickImageChooserIntent(@NonNull Context context, CharSequence title, boolean includeDocuments, boolean includeCamera, File photoFile) {
        ...
        if (!isExplicitCameraPermissionRequired(context) && includeCamera) {
            allIntents.addAll(getCameraIntents(context, packageManager, photoFile));
        }
     ...
     */
    public static List<Intent> getCameraIntents(@NonNull Context context, @NonNull PackageManager packageManager, File photoFile) {
        ...
        for (ResolveInfo res : listCam) {
            ...
            Uri fileProvider = FileProvider.getUriForFile(context, "com.applligent.jobamax.provider", photoFile);
    ...
    /**
     * Get the URI of the selected image from {@link #getPickImageChooserIntent(Context, File)}.<br>
    ...
    public static final class ActivityBuilder {
        ...
        public void start(@NonNull Fragment fragment) {
            mOptions.validate();
            fragment.startActivityForResult(getIntent(fragment.requireContext()), CROP_IMAGE_ACTIVITY_REQUEST_CODE);
        }
