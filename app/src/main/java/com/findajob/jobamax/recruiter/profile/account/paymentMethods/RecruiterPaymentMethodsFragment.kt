...
import com.findajob.jobamax.databinding.FragmentRecruiterPaymentMethodsBinding
...
@AndroidEntryPoint
class RecruiterPaymentMethodsFragment : BaseFragmentMain<FragmentRecruiterPaymentMethodsBinding>(),
    RecruiterPaymentMethodsInterface {
        ...
        viewModel.getCardDetails(object : GetCardDetailsCallback {
            override fun onSuccess(map: HashMap<String, Any>?) {
                ...
                if (brand == "visa") {
                    ...
                    binding.cardLogo.load(getDrawable(requireContext(), R.drawable.ic_visa))
                } else if (brand == "mastercard") {
                    binding.cardLogo.visibility = VISIBLE
                    binding.cardLogo.load(getDrawable(requireContext(), R.drawable.ic_mastercard))
                }

                binding.cardText.text = "Remove Card"
                binding.cardImage.load(getDrawable(requireContext(), R.drawable.ic_remove_circle))
            ...
            override fun onFailure(e: Exception?) {
                ...
                binding.cardImage.load(getDrawable(requireContext(), R.drawable.ic_add_circle))
    ...
    override val layoutRes: Int
        get() = R.layout.fragment_recruiter_payment_methods
