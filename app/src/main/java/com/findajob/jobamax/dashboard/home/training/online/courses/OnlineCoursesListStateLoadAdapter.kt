...
class OnlineCoursesListStateLoadAdapter(private val retry :() ->  Unit,) :
    LoadStateAdapter<OnlineCoursesListStateLoadAdapter.LoadStateViewHolder>(
    ...
    inner class LoadStateViewHolder(private val binding: OnlineCourseLoadStateFooterBinding):
        ...
        fun bind(loadState: LoadState){
            binding.apply {
                ...
                errorTextView.setText(R.string.online_course_error_loading)
