...
import com.jobamax.appjobamax.databinding.FragmentSeekerTrackingJobDetailsBinding
import com.jobamax.appjobamax.databinding.ItemSeekerTrackingJobDetailCardBinding
import com.jobamax.appjobamax.dialog.SeekerJobTrackingCardDialog
...
class SeekerTrackingJobDetailsFragment : BaseFragmentMain<FragmentSeekerTrackingJobDetailsBinding>() {
    ...
    private fun setAdapter() {
        adapter = SeekerTrackingJobDetailsAdapter(existingPhaseList, false, requireContext())
...
class SeekerTrackingJobDetailsAdapter(
    var list: ArrayList<Phase>,
    var isSelected: Boolean,
    val requireContext: Context
) : RecyclerView.Adapter<SeekerTrackingJobDetailsAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.apply {
            this.tvDate.text = convertDateToCurrentLanguage(phase.date, requireContext.getLanguage())
            this.tvName.text = convertPhaseNameInCurrentLanguage(phase.name, requireContext.getLanguage())
            if (phase.name == "Added to wishlist" || phase.name == "Ajouté à la liste de souhaits"){
