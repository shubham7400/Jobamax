...
class FilterJobSearchTagFragment : BaseFragment() {
    ...
    lateinit var adapter: FilterJobSearchTagAdapter
    ...
    private fun setClickListeners() {
        ...
        binding.tvRemoveAllTags.setOnClickListener {
            jobSearchKeywords.clear()
    ...
    private fun configureCriteriaCategories() {
         adapter = FilterJobSearchTagAdapter(CriteriaCategory.getCriteriaCategory(), requireActivity(), jobSearchKeywords)
