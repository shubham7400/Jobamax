...
class RecruiterImportSeekerToQualifyingStepDialogFragment : DialogFragment() {
    ...
    private fun validateReason() {
        if (selectedFolderSeekers.isEmpty()) {
            binding.btnImport.isEnabled = false
            binding.btnImport.background = requireActivity().resources.getDrawable(R.drawable.rounded_grey_box_50, null)
            binding.btnImport.setTextColor(requireActivity().resources.getColor(R.color.navi_blue, null))
        } else {
            binding.btnImport.isEnabled = true
            binding.btnImport.background = requireActivity().resources.getDrawable(R.drawable.rounded_bottom_purple_top_blue_50, null)
            binding.btnImport.setTextColor(requireActivity().resources.getColor(R.color.white, null))
        }
    }
