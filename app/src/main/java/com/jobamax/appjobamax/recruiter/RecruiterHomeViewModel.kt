...
class RecruiterHomeViewModel : ViewModel() {
    ...
    // set company subscription
    private val _companySubscription = MutableLiveData<CompanySubscription?>()
    val companySubscription: LiveData<CompanySubscription?> get() = _companySubscription
    fun setCompanySubscription(cs : CompanySubscription){
        _companySubscription.value = cs
    }
}